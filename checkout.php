   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='order-detail'>
            ...
            <span class='total'> total : Tk".$price_total."/-  </span>
         </div>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total"> grand total : TK<?= $grand_total; ?>/- </span>
   </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. Uttara" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="e.g. BD" name="country" required>
         </div>
         <div class="inputBox">
            <span>pin code</span>
